...
reset=false;
  ...
  this.auth.VerifyEmail(this.ResetForm.email).subscribe(res=>{
  ...
  sendmail(verificationCode:any){
    let user={
      ...
      body:`<body style="font-family: Courier New, monospace; background-color: #344ff7; margin: 0;">
